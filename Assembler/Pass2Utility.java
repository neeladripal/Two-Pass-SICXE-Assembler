...
public class Pass2Utility {
    ...
    public static void generateObj(String inputFile, SymbolTable symbolTable, LinkedList<Literal> literalTable) throws IOException{
        ...
        )
        {
            ...
            while (instruction != null){
                ...
                // TODO This part might not work properly
                // EXTDEF
            ...
            System.out.println("Unhandled error occurred during Pass 2. Please open the " + name + ".txt and " + name + ".o to see the output.");
            System.exit(1);
        }

    }

    // Generate M records given the Symbol Table, and the full instruction as an array of strings
    ...
    // this function returns array of strings containing fields of an intermediate instruction
